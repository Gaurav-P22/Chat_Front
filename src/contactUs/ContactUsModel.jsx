      ...
      <div className="bg-white p-6 rounded-lg shadow-md   max-w-2xl w-full">
        ...
        <div>
          <p className="mb-4 text-slate-800">
            Hi there! I'm Gaurav Prajapati, a passionate full-stack developer
          ...
          <div className=''>
            ...
            <table className='flex flex-col gap-y-3 p-4 text-center'>
                <tr>
                    ...
                    <td className=' text-blue-800 underline px-4'>harshita.2224mca@kiet.edu</td>
                </tr>
                <tr>
                    <td>Hayat Khan</td>
                    <td className=' text-blue-800 underline px-4'>Hayat.2224mca@kiet.edu</td>
                </tr>
            </table>
          </div>
